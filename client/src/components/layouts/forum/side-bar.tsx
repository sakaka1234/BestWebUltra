...
export const SideBarForum = () => {
    const sideBarActive = (path: string) => {
        ...
        return currentPath === path ? "bg-[#31363B] text-[#FF571A]" : "text-[#F7F7F7]";
    };
        ...
        <div className="w-[300px] p-[20px] rounded-[16px] bg-[#262D34]">
            ...
            <ul className="mt-[20px] flex flex-col gap-[15px]">
                {sideBarItems.map((item, index) => (
                    <li key={index} className={`flex items-center gap-[10px] rounded-[10px] p-[5px] hover:bg-[#31363B] transition-all duration-200 
